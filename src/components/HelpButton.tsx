...
const STEP_FAQ: Record<HelpStep, FaqItem[]> = {
  ...
  step2: [
    ...
    {
      question: '피드백 보기 버튼은 뭔가요?',
      answer:
        '활동을 완료하면 나타나는 버튼이에요. 누르면 내 답에 맞는 힌트·설명을 보여 주고, 피드백을 반영한 뒤 정답 비교를 할 수 있어요. 일부 활동(카드 매칭·서술형)은 AI 맞춤 피드백을 사용해요.'
    }
  ],
  step3: [
    {
    ...
    },
    {
      ...
      answer:
        '네, 가치 판단 화면 상단에 1·2단계 결과가 자동으로 요약돼요. 펼치기 버튼을 누르면 자세히 볼 수 있어요.'
    },
    {
